...
if __name__ == "__main__":
    ...
    # all-full carries the parameter-matched ablation variants (Standard/ParScale/ND-LoRA and the
    # copied Stream LoRA-BT); pub-deep lacks the P=1 baselines, so Δ% can't be computed there.
    df = pd.read_parquet(ensure_scores_parquet(plot_type="all", mode="full"))
