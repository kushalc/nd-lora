...
class CNNDMv2(ConfigurableTask):
    ...
    def construct_requests(self, doc, ctx, **kwargs):
        ...
        """
        # Override generation_kwargs to use just newline as terminator
        kwargs_copy = kwargs.copy()
        # Let parent ConfigurableTask handle chat template logic properly
        return super().construct_requests(doc, ctx, **kwargs_copy)
